...
- **A ceiling of zero hatches the entire half**, the loudest thing this bar can say. The line drew on the centre divider, where it could be mistaken for the divider itself.
