...
- **±2 000 ms** — 3.03× the measured maximum lifetime of an excursion (661 ms; `docs/waypoints.md` §"The first fix of a run" has the derivation), and short enough that the bike cannot cross the distance threshold inside it: 300 km/h for 2 s is 167 m against 222 m in latitude.
