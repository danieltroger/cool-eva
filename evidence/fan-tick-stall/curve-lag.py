...
def main():
    ...
    print("# The SWEEP figures in docs/fan-control.md §9 come from here: sample counts, held")
    print("# divergences, the grace sweep and the mutant column. ⚠️ The row counts, clock-step")
    print("# arithmetic and coolant/current figures quoted in §9, and all of")
    print("# docs/ride-log-clock.md §6, are one-off queries and are NOT regenerated by this.")
    print(f"# Corpus: rides.db read 2026-09-19 — {readings} readings across {sessions} sessions.")
    print("# ⚠️ docs/ride-log-clock.md §1 quotes the same file at 2026-09-13 (35 168 921 readings,")
    print("# 130 boots). Two snapshots of one growing archive; neither supersedes the other.")
    print()
