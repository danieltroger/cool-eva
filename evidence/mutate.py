...
MUTANTS = [
    ...
    ("M6", "speed bound widened to 3000", "scripts/route-track.ts",
     "AND r.value BETWEEN 0 AND 300\n", "AND r.value BETWEEN 0 AND 3000\n", "scripts/check-route-track.ts"),
    ...
    ("N7", "an existing staging file no longer stops the import", "scripts/ride-import.ts",
     "if (await pathExists(stagingPath)) {", "if (false && (await pathExists(stagingPath))) {",
     "scripts/check-import-ride-log.ts"),
