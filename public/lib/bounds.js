...
const BY_KEY = {
  ...
  "fan_auto_mode": [0, 2],
  // FAN_OFF_STATE in src/fan/gesture-runner.ts. Named for the reason `fan_driver_enabled`
  // is: blank unit in a non-boolean group is the combination that renders ungated.
  "fan_off_state": [0, 2],
  "fan_auto_reason": [0, 8],
  "fan_temp_input": [0, 2],
