...
//
// Only type 25 is handled here on purpose. Everything else on this ID either
// duplicates a value we already take from the Bluetooth link or a broadcast frame
// — two sources for one signal can only disagree — or is the GPS multiplex, which
// src/can/gps.ts decodes off these same frames.
//
