...
> {
  ...
  if (
    ...
    chargeManagerIsLive(latestValue("charge_manager_state"), ageMs("charge_manager_state"))
  ) {
    return {
      ok: false,
      reason:
        `a charge session is live (charge_manager_state is fresh) — do not ${request.kind} mid-charge. ` +
